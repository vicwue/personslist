sap.ui.jsview("personslist-web-vic.personslist", {

	getControllerName: function() {
		return "personslist-web-vic.personslist";
	},
	...
	createContent: function(oController) {
		...
		var oAddPersonButton = new sap.ui.commons.Button({
			...
			text: "Add Person",
			press: function() {
				oController.addNewPerson(sap.ui.getCore().getControl("firstNameFieldId").getValue(), sap.ui.getCore().getControl("lastNameFieldId").getValue(), oTable);
			}
		});
